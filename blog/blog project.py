...
scrapy shell "https://nycdatascience.com/blog/student-works/taiwan-vote-data-project-in-r-shiny/" #200
...
import scrapy
class Blog(scrapy.Item):  #each review is an instance of the bestbuyitem
...
4. create spider, create file called blog_spider.py under blog/spiders
...
5. In blog_spider.py, import the Spider class and the nycdsa class we defined earlier in items.py.
